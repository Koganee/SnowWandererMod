package net.kogane.snowwanderermod.entity.client;// Made with Blockbench 4.10.4
...
public class SnowWandererModel<T extends SnowWandererEntity> extends HierarchicalModel<T> {
	private final ModelPart snow_wanderer;
	private final ModelPart head;

	public SnowWandererModel(ModelPart root) {
		this.snow_wanderer = root.getChild("snow_wanderer");
	...
	@Override
	public void setupAnim(SnowWandererEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
